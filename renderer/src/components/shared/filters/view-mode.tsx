...
export function ViewMode({ setViewMode, viewMode }: Props) {
  return (
    <div className="sm:flex self-center gap-2 p-1 rounded-test-md shrink-0 bg-sidebar border">
      <Button
      ...
      >
        <Icon
          name="LayoutGrid"
          size={16}
          className={`text-muted-foreground ${viewMode === "card" ? "text-primary" : ""
            }`}
        />
      </Button>
      <Button
      ...
      >
        <Icon
          name="Grid3x3"
          size={16}
          className={`text-muted-foreground ${viewMode === "table" ? "text-primary" : ""
            }`}
        />
      </Button>
    </div>
