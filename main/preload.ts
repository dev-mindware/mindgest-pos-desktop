...
contextBridge.exposeInMainWorld("ipc", {
  ...
  lan: {
    ...
    startDiscovery: (params?: { lastKnownMasterIp?: string }) => ipcRenderer.invoke("lan:start-discovery", params),
    stopDiscovery: () => ipcRenderer.invoke("lan:stop-discovery"),
    getDiscoveredMasters: () => ipcRenderer.invoke("lan:get-discovered-masters"),
    diagnoseSwitch: (params: { targetIp: string; port?: number }) => ipcRenderer.invoke("lan:diagnose-switch", params),
